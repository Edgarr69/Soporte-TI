...
function ThemeToggleIcon() {
  ...
  const iconVariants = {
    visible: { opacity: 1, scale: 1,   rotate: 0,   display: 'block' as const },
    hidden:  { opacity: 0, scale: 0.5, rotate: 180, display: 'none'  as const },
  }
  return (
    <div className="flex items-center justify-center relative size-4">
      <motion.svg viewBox="0 0 384 512" className="absolute h-full" xmlns="http://www.w3.org/2000/svg"
        variants={iconVariants} animate={isLight ? 'visible' : 'hidden'}
      ...
      <motion.svg viewBox="0 0 512 512" className="absolute h-full" xmlns="http://www.w3.org/2000/svg"
        variants={iconVariants} animate={isLight ? 'hidden' : 'visible'}
        transition={{ duration: 0.5, ease: 'easeInOut' }}>
